...
int main(int argc, char **argv) {
  ...
  ros::service::waitForService("/robot/get_device_list");
  ros::spinOnce();
  ...
  ros::ServiceClient enableRangeFinderClient =
    n.serviceClient<webots_ros::set_int>("/" + std::string(rangeFinderName) + "/enable");
  ...
  if (enableRangeFinderClient.call(enableRangeFinderSrv) && enableRangeFinderSrv.response.success) {
    ...
    subRangeFinderRangeFinder = n.subscribe("/" + std::string(rangeFinderName) + "/range_image", 1, rangeFinderCallback);
  ...
  ros::ServiceClient rangeFinderSaveImageClient =
    n.serviceClient<webots_ros::save_image>("/" + std::string(rangeFinderName) + "/save_image");
  ...
  ros::ServiceClient motorSetPositionClient =
    n.serviceClient<webots_ros::set_float>("/" + std::string(motorName) + "/set_position");
  ...
  ros::ServiceClient motorGetTargetPositionClient =
    n.serviceClient<webots_ros::get_float>("/" + std::string(motorName) + "/get_target_position");
